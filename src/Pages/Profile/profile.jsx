        ...
        <>
            <MainLayOut>
                <div className="wrapper">
                    ...
                    <div className="home-right w-[81.2%] bg-white">
                        ...
                        {
                            isLoading ? <CustomSpinner h={10} w={10} font={'sm'}/>
                                :
                                <>
                                    {
                                        isSuccess && (
                                            <>
                                                <div className="items-center  text-sm gap-6 my-8 mx-8 px-1  ">
                                                    <div className="flex-1 pr-5 px-12 text-lef w-4/6">
                                                        ...
                                                        <div
                                                            className="flex pt-3 pb-5 items-center gap-6 text-right">
                                                        ...
                                                        <div className="flex pt-3 pb-5  gap-6 text-right">
                                                            <Tooltip placement="top"
                                                                     title={<p>Nhận thông báo tới email khi đấu giá
                                                                         thành công</p>}
                                                                     arrow={true}>
                                                            ...
                                                            <label
                                                                ...
                                                                <input id="switch" type="checkbox"
                                                                       defaultChecked={userData.receiveAuctionSuccessEmail}
                                                                       onChange={(e) => handleData('receiveAuctionSuccessEmail', e.target.checked)}
                                                    ...
                                                    peer-checked:after:border-white peer-focus:ring-green-300"></div>
                                                        ...
                                                        >
                                                            ...
                                                            <button
                                                                disabled={!check}
                                                                className={`${check ? 'bg-orange-500 hover:bg-orange-600' : 'bg-gray-300 cursor-no-drop'}  text-white px-7 py-2 text-base rounded  active:bg-orange-700 border-none`}>
                                                                Lưu
                                                            </button>
                                                        </div>
                                                    </div>
