                            ...
                            <div className="grid xl:grid-cols-7 lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-2 min-[200px]:grid-cols-1 items-start gap-6 p-3 m-2 mt-4 ">
                                    ...
                                    >
                                        {selectedImage && (
                                            <img onMouseEnter={handleMouseEnter}
                                                                ...
                                                                className="zoom-image cursor-crosshair"
                                                                alt="Magnified"
                                            />)}
                                    </div>
                                    <div id="carousel"
                                ...
                                <div className="xl:col-span-3  md:col-span-4 lg:col-span-2 sm:col-span-2">
                                    ...
                                    <div
                                        ...
                                        <div style={{fontWeight: 600}} className="flex pr-8 relative">
                                            ...
                                            <Popover content={<div className="flex items-center gap-3 py-2 px-3">
                                                <span>Chia sẻ :</span>
                                                <FacebookShareButton
                                                    url={`${baseFEUrl}/auction/stream/item/${auctionProductData.product_id}`}
                                                    quote={'Dummy text!'}
                                                >
                                        ...
                                        <span
                                            className="text-center font-medium mt-6 text-neutral-600 mb-3">Thời gian đăng ký còn lại </span>
                                    ...
                                    <div style={{backgroundColor: "white"}}
                                         className="pt-1 pb-1  mb-5 font-medium text-neutral-600 font-sans text-left">
                                        ...
                                        <div className="grid min-[200px]:grid-cols-3  text-center 0 my-2 gap-4 px-5 p-2  items-center">
                                    ...
                                    <div style={{backgroundColor: "white"}}
                                        ...
                                        <div className="0 gap-4 px-4 p-3 pb-2 font-sans text-neutral-600">
                                            ...
                                            <div className="flex-row flex gap-3 mb-3">
                                                ...
                                                <div
                                                    className="basis-3/5">{formatMoney(auctionProductData?.min_price)} VND
                                                </div>
                                            </div>
