        ...
        <>
            ...
            <div className="wrapper">
                ...
                <div className="home-right ">
                    ...
                    {
                        isScCount && <div className="flex justify-around flex-wrap">
                            <>
                                <TabItem data={pending} count={reqCount.count_penR}
                                         onClick={() => handelClick(1)} isSelected={selectedTab === 1}></TabItem>
                                <TabItem data={tabData[0]} count={reqCount.count_appR}
                                         onClick={() => handelClick(2)} isSelected={selectedTab === 2}></TabItem>
                                <TabItem data={tabData[1]} count={reqCount.count_bidR}
                                         onClick={() => handelClick(3)} isSelected={selectedTab === 3}></TabItem>
                                <TabItem data={tabData[2]} count={reqCount.count_sucR}
                                         onClick={() => handelClick(5)} isSelected={selectedTab === 5}></TabItem>
                                <TabItem data={tabData[4]} count={reqCount.count_cfR}
                                         onClick={() => handelClick(6)} isSelected={selectedTab === 6}></TabItem>
                                <TabItem data={tabData[5]} count={reqCount.count_dlvR}
                                         onClick={() => handelClick(7)} isSelected={selectedTab === 7}></TabItem>
                                <TabItem data={tabData[6]} count={reqCount.count_cplR}
                                         onClick={() => handelClick(8)} isSelected={selectedTab === 8}></TabItem>
                                <TabItem data={tabData[3]} count={reqCount.count_failR}
                                         onClick={() => handelClick(10)} isSelected={selectedTab === 10}></TabItem>
                                <TabItem data={tabData[7]} count={reqCount.count_calR}
                                         onClick={() => handelClick(11)} isSelected={selectedTab === 11}></TabItem>
                                <TabItem data={tabData[8]} count={reqCount.count_rejR}
                                         onClick={() => handelClick(13)} isSelected={selectedTab === 13}></TabItem>
                            </>
                        </div>
                    }
