                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div className="flex flex-col ">
                                                                                ...
                                                                                <Radio.Group buttonStyle="solid" disabled
                                                                                             defaultChecked={true}
                                                                                             defaultValue={productData?.product_id?.rank}
                                                                            ...
                                                                            <div className="flex flex-col ">
                                                                                ...
                                                                                <Radio.Group buttonStyle="solid"
                                                                                             defaultValue={productData?.product_id?.is_used}
                                                                                             className="font-semibold">
                                                                            ...
                                                                            <div className="flex flex-row items-center">
                                                                                <span
                                                                                    className="font-medium text-neutral-600 mr-2">Trả hàng</span>
                                                                                {
                                                                            ...
                                                                            <div className="flex flex-col ">
                                                                                <div
                                                                                    className=" font-medium text-neutral-500">Phí
                                                                                    giao hàng
                                                                                </div>
                                                                                <div
                                                                            ...
                                                                            <div className="flex flex-col ">
                                                                                <div
                                                                                    className=" font-medium text-neutral-500">Mô
                                                                                    tả sản phẩm
                                                                                </div>
                                                                                <div
