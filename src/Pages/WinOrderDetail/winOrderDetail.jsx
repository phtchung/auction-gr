                    ...
                    <div className="home-right bg-white">
                        {
                            isLoading ?
                                ...
                                :
                                isError ?
                                    <FZFNotFound margin={'-mt-20'} btnText={'Trở về'} error={'Rất tiếc, không tìm thấy thông tin phù hợp.'} urlReturn={'/winOrderTracking'} />
                                    :
                                    isSuccess &&
                                    <>
                                                    ...
                                                    <div
                                                        ...
                                                        <div className="w-full">
                                                            ...
                                                            <div className="mt-2 mr-2 w-full  flex">
                                                                ...
                                                                <div className="ml-2 w-full">
                                                                    <h6 className={`text-sm font-bold ${winDetailData.delivery_start_time ? 'text-green-500' : ' text-gray-300'} `}>Bắt đầu giao hàng
                                                                    </h6>
                                                            ...
                                                            winDetailData.status === 9 || winDetailData.status === 14 || winDetailData.status === 15 ?
                                                                <>
                                                                    ...
                                                                    <div className="w-full">
                                                                        ...
                                                                        <div className="mt-2 mr-2 w-full  flex">
                                                                            {(winDetailData.approve_return_time || winDetailData.deny_return_time ) && <CheckOKSvg/>}
                                                                            <div className="ml-2 w-full">
                                        ...
                                        {isSuccess && (winDetailData.status === 9 || winDetailData.status === 14 || winDetailData.status === 15) && (
                                            <>
                                                <div className="flex justify-between text-neutral-700 m-2.5 items-center px-2">
                                                    <div className="text-left px-4 text-sm font-semibold ">
                                                        Yêu cầu trả hàng
                                                    </div>
                                                </div>

                                                <div
                                                    className="items-center gap-6 font-medium text-neutral-500  my-6 mx-8 px-1 text-sm space-y-4 ">
