...
import useDepositRegistration from "../DepositRegistration/useDepositRegistration.jsx";
                                    ...
                                    <>
                                        {
                                            isSuccess && (
                                                data.auction_deposit === 0 ?
                                                    <>
                                                        <div
                                                            className="my-6 font-medium text-center flex flex-col gap-8  text-base text-neutral-600">
                                                        <span className="mx-6">
                                                            Bạn
                                                        cần đăng ký các mức cọc đấu giá của hệ thống trước khi yêu cầu bán đấu giá
                                                        </span>

                                                            <button
                                                                onClick={() => navigate('/depositRegistration')}
                                                                className="text-white mx-auto bottom-2 bg-orange-500 hover:bg-orange-600 focus:ring-1
                                                         hover:border-orange-500 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2">
                                                                Đăng ký ngay
                                                            </button>
                                                        ...
                                                        <div className="m-8">
                                                            ...
                                                            >
                                                                ...
                                                                <div className="grid lg:grid-cols-2 md:grid-cols-1">
                                                                    ...
                                                                    >
                                                                        <Select
                                                                            ...
                                                                            <Option value="S">S (Superior, chất lượng trên
                                                                                90% )</Option>
                                                                            <Option value="A">A (Excellent, chất lượng trên
                                                                                80%) </Option>
                                                                            <Option value="B">B (Good, chất lượng trên
                                                                                70%)</Option>
                                                                            <Option value="C">C (Fair, chất lượng trên
                                                                                60%)</Option>
                                                                            <Option value="D">D (Poor, chất lượng trên
                                                                                50%)</Option>
                                                                        </Select>
                                                                    </Form.Item>
                                                              ...
                                                              <span className="lg:ml-14">
                                                                <FileUpload length={1}
                                                                            onGetFormData={handleSingleFileUpload}/>
                                                              </span>
                                                                    </Form.Item>
