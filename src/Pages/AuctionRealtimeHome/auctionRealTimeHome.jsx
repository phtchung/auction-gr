...
import useAuctionRealTimeHome from "./useAuctionRealTimeHome.jsx";
import CustomSpinner from "../../Components/CustomSpinner/CustomSpinner.jsx";
import {useLocation} from "react-router-dom";

const AuctionRealTimeHome = () => {
    const {isSuccess , isLoading,data , setType , type, setQueryString, queryString , totalPage,currentPage,handlePageChange } = useAuctionRealTimeHome()
    ...
    return (
        <>
            <MainLayOut style={{zIndex: 10000}}>
                {/*Search*/}
                <div className="header_container z-50 lg:mx-[-8.04rem] md:mx-[-4.04rem] bg-orange-500 opacity-90 border border-t-amber-50"
                    ...
                    categories && sc ?
                        <>
                            <div
                                ...
                                <div className=" relative ">
                                    <div
                                        className="mb-10 mt-4 mx-auto md:w-1/2  items-center justify-between text-base font-medium w-full ">
...
export default AuctionRealTimeHome
