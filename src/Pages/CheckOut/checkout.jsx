    ...
    return (
        <>
            <MainLayOut style={{zIndex: 10000}}>
                <div
                    className={`lg:py-8 lg:px-4 md:p-6 sm:p-4 w-full h-full mt-20 ${isPending ? 'bg-opacity-60' : ''}`}>
                    {isLoading ?
                        <>
                        ...
                        isSuccess &&
                        <>
                            <div className="grid lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 text-sm">
                                <div className="lg:col-span-1 lg:mr-2 sm:mr-0 md:col-span-1 sm:col-span-1  px-1.5 ">
                                ...
                                <div
                                    ...
                                    <div className="w-full h-full rounded-lg bg-zinc-200">
                                        <div className="h-full  py-2 px-2">
                                            <Tabs size={"large"} defaultActiveKey="1" centered tabBarGutter={200}
                                                  indicator={{size: 300}}>
                                                    ...
                                                    <div className="flex flex-col gap-4">
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p className="text-neutral-500">Quét mã để thanh toán </p>
                                                                </div>
                                                            </div>
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p className="text-neutral-500 text-sm">Ngân hàng :</p>
                                                                        <p className="text-lg text-left font-semibold text-neutral-600">Ngân
                                                                            hàng Nông Nghiệp và Phát triển nông thôn Việt Nam - Chi nhánh Mỹ Đình</p>
                                                                    </div>
                                                                    <div
                                                                        className=" flex flex-col items-start mb-2">
                                                                        <p className="text-neutral-500 text-sm">Số tài khoản :</p>
                                                                        <p className="text-lg text-left font-semibold text-neutral-600">180601888999</p>
                                                                    </div>
                                                                    <div
                                                                        className=" flex flex-col items-start mb-2">
                                                                        <p className="text-neutral-500 text-sm">Nội dung chuyển khoản :</p>
                                                                        <p className="text-lg text-left font-semibold text-neutral-600">{data?.data?.content}</p>
                                                                    </div>
                                                                    <div
                                                                        className=" flex flex-col items-start mb-2">
                                                                        <p className="text-neutral-500 text-sm">Số tiền :</p>
                                                        ...
                                                        <div>
                                                            <p className="text-neutral-700 text-left mx-3 mb-6 italic">
                                                                Lưu ý: Khách hàng phải nhập đúng số tài khoản, nội dung
                                                ...
                                                <TabPane tab="Thanh toán online" key="2">
                                                    <div className=" flex flex-col items-start mb-2 m-4 px-2">
                                                        <p className="text-neutral-500 text-sm">Chọn phương thức thanh toán</p>
                                                                    ...
                                                                    isPending ?
                                                                        <>
                                                                            <button disabled onClick={handleSubmit}
                                                                                    className=' opacity-70 flex flex-row cursor-not-allowed bg-gray-400 rounded-md items-center
