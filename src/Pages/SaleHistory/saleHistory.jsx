...
const SaleHistory = () => {
    ...
    const {saleHistoryData , isLoading , isSuccess,total, queryString , setQueryString} = useSaleHistory()
                                    ...
                                    <Table sx={{
                                        ...
                                        <TableBody>
                                            {saleHistoryData.map((row) => (
                                                <TableRow
                                                    onClick={() => navigate(`/saleHistory/reqOrderDetail/${row.request_id}?status=${row.status}`)}
                                                    key={row.productId}
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="center">{row.productId.slice(0,14)}</TableCell>
