  ...
  return (
    <>
        <div
            ...
            onClick={onClick}
            className={`flex-col ${isSelected ? 'border-t-orange-500 border-t-4' : ' border-t-4'}   cursor-pointer m-3 border-2 border-gray-300 w-44 text-left relative bg-gray-200`}
        >
            <div className={`px-3 leading-8 text-sm ${isSelected ? 'text-orange-500 ' : 'text-stone-600'}`}>
                {data.name}
            </div>
