        ...
        <>
            <div
                ...
                <div
                    ...
                    <a href="#"
                       className="flex items-center space-x-2 bg-orange-500 hover:bg-orange-700 text-white px-4 py-2 rounded transition duration-150"
                       title="Return Home">
                ...
                <div className="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
                    ...
                    <svg className="w-full text-blue-600" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <circle cx="212.59226" cy="103" r="64" fill="red"></circle>
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-39.70387 -61.04208)" fill="orange"></path>
                        <path
                            ...
                            transform="translate(-39.70387 -61.04208)" fill="rgb(242, 124, 8)"></path>
                        <path
