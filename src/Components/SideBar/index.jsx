    ...
    return (
        <>
            {userData && <>
                ...
                <aside
                    className="flex flex-col w-[17rem]  px-2 py-8 border-r ">
                    ...
                    <div className="flex flex-col justify-between flex-1 mt-6">
                        <nav>
                            ...
                            >
                                ...
                                <span className="mx-4 text-neutral-600 text-base font-medium">Hồ sơ cá nhân</span>
                            </NavLink>
                            ...
                            <NavLink
                                ...
                                <span className="mx-4 text-neutral-600 text-base font-medium">Đơn bán</span>
                            </NavLink>
                            ...
                            >
                                ...
                                <span className="mx-4 text-neutral-600 text-base font-medium">Đơn mua</span>
                            </NavLink>
                            ...
                            >
                                ...
                                <span className="mx-4 text-neutral-600 text-base font-medium">Đang tham gia</span>
                            </NavLink>
                            ...
                            >
                                ...
                                <span className="mx-4 text-neutral-600 text-base font-medium">Lịch sử đấu giá</span>
                            </NavLink>
                            ...
                            >
                                ...
                                <span className="mx-4 text-neutral-600 text-base font-medium">Lịch sử bán</span>
                            </NavLink>


                            <NavLink
                                to="/reqHistory"
                                style={{color: activeItem === 'reqHistory' ? 'orange' : ''}}
                            ...
                            >
                                ...
                                <span className="mx-4 text-neutral-600 text-base font-medium">Lịch sử yêu cầu</span>
                            </NavLink>
                        </nav>
                    </div>
                </aside>
